...
import com.solpyra.domain.admin.dto.AdminShopeeOrder;
...
public interface AdminShopeeOrderMapper {
  ...
  void updateShopeeOrder(@MappingTarget ShopeeOrder entity, ShopeeOrder imported);
